    ...
    <div className='flex'>
        ...
        <div className='ml-[380px] py-6 w-full mt-6'>
            ...
            <div className='flex gap-4 my-6 border-b'>
                ...
                <NavLink to="bookings" className={({ isActive }) => `text-2xl px-4 py-2 ${isActive ? 'bg-[#FFD50099] rounded-lg' : 'bg-white-800'}`}>Bookings</NavLink>
                <NavLink to="categories" className={({ isActive }) => `text-2xl px-4 py-2 ${isActive ? 'bg-[#FFD50099] rounded-lg' : 'bg-white-800'}`}>Categories</NavLink>
            </div>
            <Outlet />
        </div>
    </div>
