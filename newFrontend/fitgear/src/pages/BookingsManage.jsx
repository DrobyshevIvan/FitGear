...
export default function BookingsManage() {
    ...
    const filteredBookings = bookings
        ...
        .filter(b => b.announcement.title.toLowerCase().includes(searchQuery.toLowerCase()));
    ...
    return (
        <div>
            <div className="flex justify-between items-start">
                <div className="w-full pr4 max-w-[80%]">
                    <input 
                        type="text"
                        placeholder="Search by announcements"
                        value={searchQuery}
                ...
                <div className="w-48 shrink-0 pl-6 space-y-2 border-l border-gray-300">
                ...
                <div className="w-48 shrink-0 pl-6 pr-6 space-y-2">
                    ...
                    <button
                        ...
                        className={`block w-full text-left px-4 py-2 rounded ${
                            sortOrder === null ? 'bg-blue-500 text-white' : 'bg-gray-200'
                        }`}
                    >
                        ✕ Clear
                    </button>
